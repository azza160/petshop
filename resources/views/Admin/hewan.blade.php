                        ...
                        <div class="p-6 space-y-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    @if ($errors->has('isFavorite') && old('_form') === 'edit')
                                        <p class="text-red-500 text-xs mt-1">{{ $errors->first('isFavorite') }}</p>
                                    @endif
                                </div>
