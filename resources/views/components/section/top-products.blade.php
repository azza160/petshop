                            ...
                            <div class="bg-white rounded-2xl overflow-hidden group  transition-all duration-500 h-full flex flex-col relative border border-slate-100 shadow-md"
                                    ...
                                    <div
                                        ...
                                        @if ($product->merek)
                                            <div
                                                ...
                                                <i
                                                    class="ph ph-tag text-xs transition-transform group-hover:scale-110"></i>
                                                {{ $product->merek }}
                                            </div>
                                        @endif
                                        <div
                                ...
                                <div class="p-5 flex flex-col flex-1 relative z-10 bg-white">
                                    ...
                                    <a href="{{ route('landing.detail-product', $product->id) }}"
                                        class="w-full py-2.5 px-3 text-slate-50 text-sm font-semibold rounded-md bg-primary hover:bg-primary/70 cursor-pointer transition-all duration-300 text-center block">
                                        Lihat Detail
                                    </a>
