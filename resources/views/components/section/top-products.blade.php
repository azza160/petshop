...
<section id="top-products" class="relative py-20 bg-slate-50/50" 
    x-data="topProductsCarousel()" 
    x-init="initCarousel()">
    
    <!-- Background Decor (Circles & Blurs) -->
    <div class="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div class="absolute top-[20%] right-[-10%] w-[40%] h-[40%] bg-primary/5 rounded-full blur-3xl" data-aos="fade-in" data-aos-duration="2000"></div>
        <div class="absolute bottom-[-10%] left-[-5%] w-[35%] h-[35%] bg-secondary/5 rounded-full blur-3xl flex" data-aos="fade-in" data-aos-duration="2000" data-aos-delay="200"></div>
    </div>
    ...
    <div class="px-4 xl:max-w-[1300px] mx-auto w-full relative z-10">
        ...
        <div class="flex items-center justify-center sm:justify-end mb-10 sm:pr-3">     
            ...
            <div class="flex items-center gap-2 border border-slate-200 p-1 rounded-md bg-white shadow-sm shrink-0" data-aos="fade-left">
                <button @click="prev()" 
    ...
    <div class="bg-white rounded-2xl overflow-hidden group  transition-all duration-500 h-full flex flex-col relative border border-slate-100 shadow-md"
        ...
        <!-- Decorative BG -->
        <div class="absolute top-0 right-0 w-32 h-32 bg-primary/10 rounded-bl-full blur-2xl group-hover:scale-150 transition-transform duration-700 pointer-events-none z-0"></div>
        ...
        <div class="relative w-full aspect-[4/3] bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6 z-10 overflow-hidden">
            ...
            <div class="relative w-full h-full transform group-hover:scale-105 transition-all duration-500 rounded-lg overflow-hidden shadow-sm bg-white">
                <div class="absolute inset-0 bg-black/5 mix-blend-multiply z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
        ...
        <div class="p-5 flex flex-col flex-1 relative z-10 bg-white">
            ...
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-xs font-semibold text-primary bg-primary/10 px-2.5 py-1 rounded-sm border border-primary/20 uppercase tracking-wider">
                    {{ $product['category'] }}
                </span>
            ...
            <!-- Product Name -->
            <h3 class="text-lg font-bold text-dark mb-2 group-hover:text-primary transition-colors line-clamp-2 leading-snug">
                {{ $product['name'] }}
            </h3>
            ...
            <div class="flex items-center justify-between mb-4 border-t border-slate-100 pt-3">
                ...
                <div class="flex flex-col">
                    <span class="text-[11px] text-muted uppercase tracking-wider font-semibold">Harga</span>
             ...
             <!-- Cart Button -->
<button class="relative w-11 h-11 flex items-center justify-center bg-primary text-white rounded-lg hover:bg-emerald-600 transition shadow-sm shadow-primary/20 group">
    ...
    <!-- Plus Badge -->
    <span class="absolute -top-1 -right-1 w-4 h-4 bg-white text-primary text-[10px] font-bold rounded-full flex items-center justify-center shadow border">
        +
    </span>
</button>
            </div>
            ...
            <button class="w-full py-2.5 px-3  text-slate-50 text-sm font-semibold rounded-md bg-primary hover:bg-primary/70 cursor-pointer transition-all duration-300">
                Lihat Detail
            </button>
