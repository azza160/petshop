<div x-data="{ open: false, isScrolled: false }" 
    ...
    <header class="transition-all duration-300 text-dark relative z-50"
            :class="(isScrolled || open) ? 'bg-white/95 backdrop-blur-md shadow-sm border-b border-slate-200/80' : 'bg-transparent py-2'">
    <nav class="px-4 xl:max-w-[1300px] mx-auto flex items-center justify-between h-16">
        ...
        <ul class="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <li><a href="#" class="hover:text-primary transition">Hewan</a></li>
            <li><a href="#" class="hover:text-primary transition">Produk</a></li>
     ...
     <button
    @click="open = !open"
    class="md:hidden text-2xl cursor-pointer relative w-8 h-8"
